# Officer Insulation &amp; Pergolas — rank-and-rent microsite
...
| Item | Value |
|---|---|
| Domain | `beaconsfieldinsulation.com.au` (registered, GoDaddy fraud-pending) |
| Live URL (interim) | https://beaconsfieldinsulation.netlify.app |
...
├── pages/
│   ├── index.astro           # home (Beaconsfield primary)
...
├── whisper.js                # "Pete's Lead from Officer Insulation &amp; Pergolas" played to contractor before patching caller through
...
| Telnyx TeXML app | `BeaconsfieldRetainingWalls-Voicemail` (id `2955788144311535476`) |
...
| `TENANT_BRAND` | `Officer Insulation &amp; Pergolas` (default) | What plays after the label — full whisper is `"Pete's Lead. Pete's Lead from Officer Insulation &amp; Pergolas."` |
...
3. Submit to Google Search Console (`sc-domain:beaconsfieldinsulation.com.au`).
4. Set up Google Business Profile (needs registered business name "Officer Insulation &amp; Pergolas" first).
5. Backlink work: hipages directory, True Local AU, Yelp AU, Heritage Springs Shire community pages.
6. Shortlist 2–3 retaining wall contractors in Beaconsfield; pitch the leads with a $1,500–$2,500/mo exclusive retainer.

## Niche-fit notes

| Factor | Why this niche |
|---|---|
| Local fit | Beaconsfield/Cockatoo estates are sloped — demand is structural, not weather-cyclical |
